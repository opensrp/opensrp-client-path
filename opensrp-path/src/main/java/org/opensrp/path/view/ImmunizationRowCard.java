    ...
    private void updateStateUi() {
        ...
        if (vaccineWrapper.getDbKey() != null) {
            ...
            if (vaccine.getEventId() != null) {
                event = ecUpdater.convert(db.getEventsByEventId(vaccine.getEventId()), org.opensrp.path.db.Event.class);
            } else if (vaccine.getFormSubmissionId() != null) {
                event = ecUpdater.convert(db.getEventsByFormSubmissionId(vaccine.getFormSubmissionId()), org.opensrp.path.db.Event.class);
            }
