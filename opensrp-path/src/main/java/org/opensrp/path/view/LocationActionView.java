...
public class LocationActionView extends LinearLayout {
    ...
    public LocationActionView(Context context, org.opensrp.Context openSrpContext) {
        super(context);
    ...
    public LocationActionView(Context context, org.opensrp.Context openSrpContext, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        this.openSrpContext = openSrpContext;
        init();
    ...
    public LocationActionView(Context context, org.opensrp.Context openSrpContext, AttributeSet attrs, int defStyleAttr) {
