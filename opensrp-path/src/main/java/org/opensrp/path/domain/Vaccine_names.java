...
public class Vaccine_names {
    ...
    public Vaccine_names(long id, String name, String vaccine_type_id, String due_days, String reference_vaccine_id, String client_type, String dose_no) {
        this.id = id;
        this.name = name;
