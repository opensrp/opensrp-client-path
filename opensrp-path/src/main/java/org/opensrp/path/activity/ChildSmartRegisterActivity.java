...
import org.opensrp.path.adapter.PathRegisterActivityPagerAdapter;
import org.opensrp.path.fragment.AdvancedSearchFragment;
import org.opensrp.path.fragment.BaseSmartRegisterFragment;
import org.opensrp.path.fragment.ChildSmartRegisterFragment;
import org.opensrp.path.receiver.ServiceReceiver;
...
public class ChildSmartRegisterActivity extends BaseRegisterActivity {
    ...
    public void saveFormSubmission(String formSubmission, String id, String formName, JSONObject fieldOverrides) {
        ...
        try {
            ...
            org.opensrp.Context context = context();
    ...
    public void onBackPressed() {
        ...
        if (currentPage != 0) {
            new AlertDialog.Builder(this, R.style.PathAlertDialog)
                    ...
                    .setCancelable(false)
                    .setPositiveButton(org.opensrp.path.R.string.no_button_label,
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {

                                }
                            })
                    .setNegativeButton(org.opensrp.path.R.string.yes_button_label,
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
