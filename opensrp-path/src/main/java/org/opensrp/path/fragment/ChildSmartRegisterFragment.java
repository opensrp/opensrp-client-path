...
import org.opensrp.cursoradapter.CursorCommonObjectSort;
...
import org.opensrp.path.activity.ChildImmunizationActivity;
...
import org.opensrp.path.domain.RegisterClickables;
import org.opensrp.path.option.BasicSearchOption;
import org.opensrp.path.option.DateSort;
import org.opensrp.path.option.StatusSort;
import org.opensrp.path.provider.ChildSmartClientsProvider;
import org.opensrp.path.receiver.SyncStatusBroadcastReceiver;
import org.opensrp.path.servicemode.VaccinationServiceModeOption;
...
public class ChildSmartRegisterFragment extends BaseSmartRegisterFragment implements SyncStatusBroadcastReceiver.SyncStatusListener {
    ...
    private void populateClientListHeaderView(View view) {
        LinearLayout clientsHeaderLayout = (LinearLayout) view.findViewById(org.opensrp.R.id.clients_header_layout);
