...
import org.opensrp.path.adapter.ServiceLocationsAdapter;
...
public class LocationPickerView extends CustomFontTextView implements View.OnClickListener {
    ...
    private org.opensrp.Context openSrpContext;
    ...
    public void init(final org.opensrp.Context openSrpContext) {
