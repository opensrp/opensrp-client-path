...
import org.opensrp.path.controller.VaccinatorNavigationController;
...
import org.opensrp.view.controller.NativeAfterANMDetailsFetchListener;
import org.opensrp.view.controller.NativeUpdateANMDetailsTask;
...
import static org.opensrp.event.Event.ACTION_HANDLED;
import static org.opensrp.event.Event.FORM_SUBMITTED;
...
public class VaccinatorHomeActivity extends SecuredActivity {
    ...
    private void initialize() {
        ...
        if(getSupportActionBar() != null) {
            ...
            getSupportActionBar().setIcon(getResources().getDrawable(org.opensrp.path.R.mipmap.logo));
            getSupportActionBar().setLogo(org.opensrp.path.R.mipmap.logo);
