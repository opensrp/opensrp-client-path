...
public class StockActivity extends BaseActivity {
    ...
    public org.opensrp.Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AllSharedPreferences allSharedPreferences = org.opensrp.Context.getInstance().allSharedPreferences();
...
//
        ...
        context = org.opensrp.Context.getInstance().updateApplicationContext(this.getApplicationContext());
    ...
    class stockGridAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                StockRepository stockRepository = new StockRepository((PathRepository)VaccinatorApplication.getInstance().getRepository(),VaccinatorApplication.createCommonFtsObject(), org.opensrp.Context.getInstance().alertService());
