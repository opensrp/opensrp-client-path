...
import org.opensrp.cursoradapter.CursorCommonObjectFilterOption;
import org.opensrp.cursoradapter.CursorSortOption;
import org.opensrp.cursoradapter.SecuredNativeSmartRegisterCursorAdapterFragment;
import org.opensrp.cursoradapter.SmartRegisterPaginatedCursorAdapter;
...
import org.opensrp.path.activity.DetailActivity;
import org.opensrp.path.activity.FieldMonitorDailyDetailActivity;
import org.opensrp.path.activity.FieldMonitorMonthlyDetailActivity;
import org.opensrp.path.activity.FieldMonitorSmartRegisterActivity;
import org.opensrp.path.option.DateSort;
import org.opensrp.path.provider.FieldMonitorSmartClientsProvider;
import org.opensrp.path.servicemode.StockDailyServiceModeOption;
import org.opensrp.path.servicemode.StockMonthlyServiceModeOption;
...
public class FieldMonitorRegisterFragment extends SecuredNativeSmartRegisterCursorAdapterFragment {
    ...
    protected void add2ndColumnHeaderView() {
        LinearLayout cl = (LinearLayout) mView.findViewById(org.opensrp.R.id.clients_upper_header_layout);
        if (isDailyRegister()) {
    ...
    private CustomFontTextView addHeaderItem(String text, int weight) {
        CustomFontTextView header = new CustomFontTextView(getActivity(), null, org.opensrp.R.style.CustomFontTextViewStyle_ListView_Medium);
    ...
    protected void onInitialization() {
        ...
        mView.findViewById(org.opensrp.R.id.filter_selection).setVisibility(View.GONE);

        mView.findViewById(org.opensrp.R.id.village).setVisibility(View.GONE);

        mView.findViewById(org.opensrp.R.id.sort_selection).setVisibility(View.GONE);

        mView.findViewById(org.opensrp.R.id.sorted_by).setVisibility(View.GONE);

        mView.findViewById(org.opensrp.R.id.label_sorted_by).setVisibility(View.GONE);
    }
