...
import org.opensrp.path.service.intent.RecurringIntentService;
import org.opensrp.path.service.intent.VaccineIntentService;
import org.opensrp.path.service.intent.WeightIntentService;
...
public class VaccinatorAlarmReceiver extends BroadcastReceiver {
    ...
    private static final String serviceActionName = "org.opensrp.path.action.START_SERVICE_ACTION";
