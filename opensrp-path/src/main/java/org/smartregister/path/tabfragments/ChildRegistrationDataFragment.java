...
public class ChildRegistrationDataFragment extends Fragment {
    ...
    public void loadData() {
        if (fragmentView != null) {
            ...
            tvChildsHomeHealthFacility.setText(LocationUtils.getOpenMrsReadableName(LocationUtils.getOpenMrsLocationName(Utils.getValue(detailsMap, "Home_Facility", false))));
            ...
            tvChildsBirthHealthFacility.setText(LocationUtils.getOpenMrsReadableName(LocationUtils.getOpenMrsLocationName(childsBirthHealthFacility)));

            if (LocationUtils.getOpenMrsReadableName(LocationUtils.getOpenMrsLocationName(childsBirthHealthFacility)).equalsIgnoreCase("other")) {
            ...
            tvChildsResidentialArea.setText(LocationUtils.getOpenMrsReadableName(LocationUtils.getOpenMrsLocationName(childsResidentialArea)));
            if (LocationUtils.getOpenMrsReadableName(LocationUtils.getOpenMrsLocationName(childsResidentialArea)).equalsIgnoreCase("other")) {
