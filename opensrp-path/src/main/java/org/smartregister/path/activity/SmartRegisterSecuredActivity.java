...
import org.smartregister.path.adapter.BaseRegisterActivityPagerAdapter;
...
//        requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        setContentView(org.smartregister.path.R.layout.activity_main);

        mPager = (OpenSRPViewPager) findViewById(org.smartregister.path.R.id.view_pager);
    ...
    public void saveFormSubmission(final String formSubmission, String id, final String formName, JSONObject fieldOverrides) {
        ...
        try {
            ...
            new AlertDialog.Builder(this)
                    .setMessage(org.smartregister.path.R.string.form_saved_success_dialog_message)
                    .setTitle(org.smartregister.path.R.string.form_saved_dialog_title)
                    .setCancelable(false)
                    .setPositiveButton(org.smartregister.path.R.string.ok_button_label,
            ...
            new AlertDialog.Builder(this)
                    .setMessage((getResources().getString(org.smartregister.path.R.string.form_saved_failed_dialog_message))+" : "+e.getMessage())
                    .setTitle(org.smartregister.path.R.string.form_saved_dialog_title)
                    .setCancelable(false)
                    .setPositiveButton(org.smartregister.path.R.string.ok_button_label,
                        new DialogInterface.OnClickListener() {
    ...
    public void onBackPressed() {
        if (currentPage != 0) {
            new AlertDialog.Builder(this)
                    ...
                    .setCancelable(false)
                    .setPositiveButton(org.smartregister.path.R.string.yes_button_label,
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    switchToBaseFragment(null, currentPage);
                                }
                            })
                    .setNegativeButton(org.smartregister.path.R.string.no_button_label,
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                }
                            })
