...
import org.smartregister.path.fragment.table.ChildVaccineTable;
import org.smartregister.path.fragment.table.FieldStockVaccineTable;
import org.smartregister.path.fragment.table.WomanVaccineTable;
...
public class VaccineReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String childTablesql = childTablesql(startDate, endDate);
        ...
        String womanVaccineSQlForField = womanVaccineSQlForField(startDate, endDate);
        ...
        String childVaccineForFieldSQL = childVaccineForFieldSQL(startDate, endDate);
        ...
        String pregnantWomanSQL = pregnantWomanSQL(startDate, endDate);
    ...
    private String childTablesql(String startDate, String endDate) {
        return "select (select count(*) c from ec_child where bcg between '" + startDate + "' and '" + endDate + "' and (date('now')-dob)<1  ) bcg_0," +
    ...
    private String womanVaccineSQlForField(String startDate, String endDate) {
        return "select " +
    ...
    private String childVaccineForFieldSQL(String startDate, String endDate) {
        return "select (" +
    ...
    private String pregnantWomanSQL(String startDate, String endDate) {
        return "select " +
