...
import org.opensrp.path.activity.mocks.ChildDetailTabbedActivityTestVersion;
import org.opensrp.path.activity.mocks.MenuItemTestVersion;
...
import org.opensrp.util.EasyMap;
 ...
 */
@PrepareForTest({org.opensrp.Context.class})
...
public class ChildDetailTabbedActivityUnitTest extends BaseUnitTest {
    ...
    @Mock
    private org.opensrp.Context context_;
    ...
    public void setUp() {
        ...
        PowerMockito.mockStatic(org.opensrp.Context.class);

        Whitebox.setInternalState(org.opensrp.Context.class, "context", context_);
